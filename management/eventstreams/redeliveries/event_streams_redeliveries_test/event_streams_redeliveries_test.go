...
func TestEventStreamsRedeliveriesCreateWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/event-streams/{id}/redeliver")).WithPathParam(
		"id",
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"date_from": "2024-01-15T09:30:00Z", "date_to": "2024-01-15T09:30:00Z", "statuses": []interface{}{"failed"}, "event_types": []interface{}{"user.created"}},
...
func TestEventStreamsRedeliveriesCreateByIDWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/event-streams/{id}/redeliver/{event_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"event_id",
