...
func TestEventStreamsDeliveriesListWithWireMock(
	...
	VerifyRequestCount(t, "TestEventStreamsDeliveriesListWithWireMock", "GET", "/event-streams/id/deliveries", map[string]interface{}{"statuses": "statuses", "event_types": "event_types", "date_from": "date_from", "date_to": "date_to", "from": "from", "take": "1"}, 1)
}
