...
func (c *Client) List(
...
) (*core.Page[*int, *management.PermissionsResponsePayload, *management.ListRolePermissionsOffsetPaginatedResponseContent], error) {
	...
	readPageResponse := func(response *management.ListRolePermissionsOffsetPaginatedResponseContent) *core.PageResponse[*int, *management.PermissionsResponsePayload, *management.ListRolePermissionsOffsetPaginatedResponseContent] {
		next += 1
		results := response.Permissions
		return &core.PageResponse[*int, *management.PermissionsResponsePayload, *management.ListRolePermissionsOffsetPaginatedResponseContent]{
			Results:  results,
			Response: response,
			Next:     &next,
		}
