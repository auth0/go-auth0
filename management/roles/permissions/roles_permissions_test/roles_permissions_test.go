...
func TestRolesPermissionsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/roles/{id}/permissions")).WithPathParam(
		"id",
...
func TestRolesPermissionsAddWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/roles/{id}/permissions")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestRolesPermissionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/roles/{id}/permissions")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
