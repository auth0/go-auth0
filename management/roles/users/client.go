...
func (c *Client) List(
...
) (*core.Page[*string, *management.RoleUser], error) {
	...
	readPageResponse := func(response *management.ListRoleUsersPaginatedResponseContent) *core.PageResponse[*string, *management.RoleUser] {
		var zeroValue *string
		next := response.Next
		results := response.Users
		return &core.PageResponse[*string, *management.RoleUser]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
