...
func TestConnectionsClientsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/connections/{id}/clients")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"clients": []interface{}{map[string]interface{}{"client_id": "client_id"}}, "next": "next"},
...
func TestConnectionsClientsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/connections/{id}/clients")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
