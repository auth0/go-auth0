...
func (c *Client) Get(
...
) (*core.Page[*string, *management.ConnectionEnabledClient], error) {
	...
	readPageResponse := func(response *management.GetConnectionEnabledClientsResponseContent) *core.PageResponse[*string, *management.ConnectionEnabledClient] {
		var zeroValue *string
		next := response.Next
		results := response.Clients
		return &core.PageResponse[*string, *management.ConnectionEnabledClient]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
