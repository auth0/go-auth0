...
func TestConnectionsSCIMConfigurationGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/connections/{id}/scim-configuration")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"connection_id": "connection_id", "connection_name": "connection_name", "strategy": "strategy", "tenant_name": "tenant_name", "user_id_attribute": "user_id_attribute", "mapping": []interface{}{map[string]interface{}{"auth0": "auth0", "scim": "scim"}}, "created_at": "created_at", "updated_on": "updated_on"},
...
func TestConnectionsSCIMConfigurationCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/connections/{id}/scim-configuration")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestConnectionsSCIMConfigurationDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/connections/{id}/scim-configuration")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestConnectionsSCIMConfigurationUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/connections/{id}/scim-configuration")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["user_id_attribute", "mapping"],
                    "properties": {
                        "user_id_attribute": {"type": "string"}, "mapping": {"type": "array", "items": {"type": "object"}}
                    },
...
func TestConnectionsSCIMConfigurationGetDefaultMappingWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/connections/{id}/scim-configuration/default-mapping")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"mapping": []interface{}{map[string]interface{}{"auth0": "auth0", "scim": "scim"}}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
