...
func TestClientGrantsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/client-grants")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"next": "next", "client_grants": []interface{}{map[string]interface{}{"id": "id", "client_id": "client_id", "audience": "audience", "scope": []interface{}{"scope"}, "organization_usage": "deny", "allow_any_organization": true, "is_system": true, "subject_type": "client", "authorization_details_types": []interface{}{"authorization_details_types"}}}},
...
func TestClientGrantsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/client-grants")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["client_id", "audience"],
                    "properties": {
                        "client_id": {"type": "string"}, "audience": {"type": "string"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "client_id": "client_id", "audience": "audience", "scope": []interface{}{"scope"}, "organization_usage": "deny", "allow_any_organization": true, "is_system": true, "subject_type": "client", "authorization_details_types": []interface{}{"authorization_details_types"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestClientGrantsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/client-grants/{id}")).WithPathParam(
		"id",
...
func TestClientGrantsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/client-grants/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
