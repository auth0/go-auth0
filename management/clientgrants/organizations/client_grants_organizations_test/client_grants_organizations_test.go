...
package client_grants_organizations_test
...
func TestClientGrantsOrganizationsListWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/client-grants/{id}/organizations")).WithPathParam(
		"id",
	...
	_, invocationErr := client.ClientGrants.Organizations.List(
		context.TODO(),
		"id",
		request,
	)
