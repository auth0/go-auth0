...
func (c *Client) List(
...
) (*core.Page[*string, *management.ClientGrantResponseContent], error) {
	...
	readPageResponse := func(response *management.ListClientGrantPaginatedResponseContent) *core.PageResponse[*string, *management.ClientGrantResponseContent] {
		var zeroValue *string
		next := response.Next
		results := response.ClientGrants
		return &core.PageResponse[*string, *management.ClientGrantResponseContent]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
