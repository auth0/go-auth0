...
func TestSelfServiceProfilesListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/self-service-profiles", map[string]string{"page": "1", "per_page": "1", "include_totals": "true"}, 1)
}
...
func TestSelfServiceProfilesCreateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/self-service-profiles", nil, 1)
}
...
func TestSelfServiceProfilesGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/self-service-profiles/id", nil, 1)
}
...
func TestSelfServiceProfilesDeleteWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "DELETE", "/self-service-profiles/id", nil, 1)
}
...
func TestSelfServiceProfilesUpdateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PATCH", "/self-service-profiles/id", nil, 1)
}
