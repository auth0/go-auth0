...
func TestSelfServiceProfilesListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/self-service-profiles")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "self_service_profiles": []interface{}{map[string]interface{}{"id": "id", "name": "name", "description": "description", "user_attributes": []interface{}{map[string]interface{}{"name": "name", "description": "description", "is_optional": true}}, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "allowed_strategies": []interface{}{"oidc"}, "user_attribute_profile_id": "user_attribute_profile_id"}}},
...
func TestSelfServiceProfilesCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/self-service-profiles")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "description": "description", "user_attributes": []interface{}{map[string]interface{}{"name": "name", "description": "description", "is_optional": true}}, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "branding": map[string]interface{}{"logo_url": "logo_url", "colors": map[string]interface{}{"primary": "primary"}}, "allowed_strategies": []interface{}{"oidc"}, "user_attribute_profile_id": "user_attribute_profile_id"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestSelfServiceProfilesGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/self-service-profiles/{id}")).WithPathParam(
		"id",
...
func TestSelfServiceProfilesDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/self-service-profiles/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestSelfServiceProfilesUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/self-service-profiles/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
