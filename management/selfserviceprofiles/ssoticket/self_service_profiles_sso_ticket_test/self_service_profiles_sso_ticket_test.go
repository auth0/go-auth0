...
func TestSelfServiceProfilesSSOTicketCreateWithWireMock(
	...
	VerifyRequestCount(t, "POST", "/self-service-profiles/id/sso-ticket", nil, 1)
}
...
func TestSelfServiceProfilesSSOTicketRevokeWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/self-service-profiles/profileId/sso-ticket/id/revoke", nil, 1)
}
