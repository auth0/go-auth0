...
func TestSelfServiceProfilesSSOTicketCreateWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/self-service-profiles/{id}/sso-ticket")).WithPathParam(
		"id",
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"ticket": "ticket"},
...
func TestSelfServiceProfilesSSOTicketRevokeWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/self-service-profiles/{profileId}/sso-ticket/{id}/revoke")).WithPathParam(
		"profileId",
