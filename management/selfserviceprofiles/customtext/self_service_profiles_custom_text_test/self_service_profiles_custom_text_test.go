...
func TestSelfServiceProfilesCustomTextListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/self-service-profiles/{id}/custom-text/{language}/{page}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"language",
		gowiremock.Matching("en"),
	).WithPathParam(
		"page",
		gowiremock.Matching("get-started"),
	).WillReturnResponse(
...
func TestSelfServiceProfilesCustomTextSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/self-service-profiles/{id}/custom-text/{language}/{page}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"language",
