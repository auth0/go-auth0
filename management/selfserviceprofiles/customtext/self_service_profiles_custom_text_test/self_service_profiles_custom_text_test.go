...
func TestSelfServiceProfilesCustomTextListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/self-service-profiles/id/custom-text/en/get-started", nil, 1)
}
...
func TestSelfServiceProfilesCustomTextSetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PUT", "/self-service-profiles/id/custom-text/en/get-started", nil, 1)
}
