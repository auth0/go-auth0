...
func TestKeysCustomSigningGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/keys/custom-signing")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"keys": []interface{}{map[string]interface{}{"kty": "EC", "kid": "kid", "use": "sig", "key_ops": []interface{}{"verify"}, "alg": "RS256", "n": "n", "e": "e", "crv": "P-256", "x": "x", "y": "y", "x5u": "x5u", "x5c": []interface{}{"x5c"}, "x5t": "x5t", "x5t#S256": "x5t#S256"}}},
...
func TestKeysCustomSigningSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/keys/custom-signing")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
...
func TestKeysCustomSigningDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/keys/custom-signing")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
