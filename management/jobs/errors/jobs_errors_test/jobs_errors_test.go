...
func TestJobsErrorsGetWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/jobs/{id}/errors")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"user": map[string]interface{}{"key": "value"}, "errors": []interface{}{map[string]interface{}{}}}},
	...
	_, invocationErr := client.Jobs.Errors.Get(
		context.TODO(),
		"id",
	)
