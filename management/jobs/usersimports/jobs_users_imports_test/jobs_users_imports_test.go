...
func TestJobsUsersImportsCreateWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/jobs/users-imports")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"status": "status", "type": "type", "created_at": "created_at", "id": "id", "connection_id": "connection_id", "external_id": "external_id"},
