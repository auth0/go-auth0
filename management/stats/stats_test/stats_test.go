...
func TestStatsGetDailyWithWireMock(
	...
	_, invocationErr := client.Stats.GetDaily(
		...
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestStatsGetDailyWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestStatsGetDailyWithWireMock", "GET", "/stats/daily", map[string]interface{}{"from": "from", "to": "to"}, 1)
}
