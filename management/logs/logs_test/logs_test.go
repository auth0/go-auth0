...
func TestLogsListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/logs", map[string]string{"page": "1", "per_page": "1", "sort": "sort", "fields": "fields", "include_fields": "true", "include_totals": "true", "search": "search"}, 1)
}
...
func TestLogsGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/logs/id", nil, 1)
}
