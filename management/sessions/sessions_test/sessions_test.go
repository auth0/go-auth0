...
func TestSessionsGetWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/sessions/id", nil, 1)
}
...
func TestSessionsDeleteWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "DELETE", "/sessions/id", nil, 1)
}
...
func TestSessionsUpdateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PATCH", "/sessions/id", nil, 1)
}
...
func TestSessionsRevokeWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/sessions/id/revoke", nil, 1)
}
