...
func TestSessionsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/sessions/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "user_id": "user_id", "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "authenticated_at": "2024-01-15T09:30:00Z", "idle_expires_at": "2024-01-15T09:30:00Z", "expires_at": "2024-01-15T09:30:00Z", "last_interacted_at": "2024-01-15T09:30:00Z", "device": map[string]interface{}{"initial_user_agent": "initial_user_agent", "initial_ip": "initial_ip", "initial_asn": "initial_asn", "last_user_agent": "last_user_agent", "last_ip": "last_ip", "last_asn": "last_asn"}, "clients": []interface{}{map[string]interface{}{"client_id": "client_id"}}, "authentication": map[string]interface{}{"methods": []interface{}{map[string]interface{}{}}}, "cookie": map[string]interface{}{"mode": "non-persistent"}, "session_metadata": map[string]interface{}{"key": "value"}},
...
func TestSessionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/sessions/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestSessionsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/sessions/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestSessionsRevokeWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/sessions/{id}/revoke")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
