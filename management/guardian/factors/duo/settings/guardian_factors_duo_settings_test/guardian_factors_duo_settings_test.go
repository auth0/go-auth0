...
func TestGuardianFactorsDuoSettingsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/guardian/factors/duo/settings")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"ikey": "ikey", "skey": "skey", "host": "host"},
...
func TestGuardianFactorsDuoSettingsSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/guardian/factors/duo/settings")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
...
func TestGuardianFactorsDuoSettingsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/guardian/factors/duo/settings")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": [],
                    "properties": {
