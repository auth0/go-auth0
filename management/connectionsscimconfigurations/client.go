...
func (c *Client) GetConnectionsSCIMConfigurations(
	ctx context.Context,
	request *management.GetConnectionsSCIMConfigurationsRequest,
	opts ...option.RequestOption,
) (*management.ListSCIMConfigurationsResponseContent, error) {
	response, err := c.WithRawResponse.GetConnectionsSCIMConfigurations(
		ctx,
		request,
		opts...,
	)
