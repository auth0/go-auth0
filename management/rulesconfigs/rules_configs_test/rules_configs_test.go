...
func TestRulesConfigsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/rules-configs")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"key": "key"}},
...
func TestRulesConfigsSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/rules-configs/{key}")).WithPathParam(
		"key",
...
func TestRulesConfigsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/rules-configs/{key}")).WithPathParam(
		"key",
		gowiremock.Matching("key"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
