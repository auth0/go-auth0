...
func TestAttackProtectionCaptchaGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/attack-protection/captcha")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"active_provider_id": "active_provider_id", "arkose": map[string]interface{}{"site_key": "site_key", "fail_open": true, "client_subdomain": "client_subdomain", "verify_subdomain": "verify_subdomain"}, "auth_challenge": map[string]interface{}{"fail_open": true}, "hcaptcha": map[string]interface{}{"site_key": "site_key"}, "friendly_captcha": map[string]interface{}{"site_key": "site_key"}, "recaptcha_enterprise": map[string]interface{}{"site_key": "site_key", "project_id": "project_id"}, "recaptcha_v2": map[string]interface{}{"site_key": "site_key"}, "simple_captcha": map[string]interface{}{"key": "value"}},
