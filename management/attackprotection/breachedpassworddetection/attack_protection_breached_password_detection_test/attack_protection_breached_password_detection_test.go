...
package attack_protection_breached_password_detection_test
...
func TestAttackProtectionBreachedPasswordDetectionGetWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/attack-protection/breached-password-detection")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"enabled": true, "shields": []interface{}{"block"}, "admin_notification_frequency": []interface{}{"immediately"}, "method": "standard", "stage": map[string]interface{}{"pre-user-registration": map[string]interface{}{"shields": []interface{}{"block"}}, "pre-change-password": map[string]interface{}{"shields": []interface{}{"block"}}}},
	...
	_, invocationErr := client.AttackProtection.BreachedPasswordDetection.Get(
		context.TODO(),
	)
...
func TestAttackProtectionBreachedPasswordDetectionUpdateWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/attack-protection/breached-password-detection")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
	...
	_, invocationErr := client.AttackProtection.BreachedPasswordDetection.Update(
		context.TODO(),
		request,
	)
