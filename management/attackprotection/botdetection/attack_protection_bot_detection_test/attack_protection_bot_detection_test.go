...
func TestAttackProtectionBotDetectionReadWithWireMock(
	t *testing.T,
) {
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/attack-protection/bot-detection")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"allowlist": []interface{}{map[string]interface{}{"key": "value"}}, "monitoring_mode_enabled": true},
	...
	_, invocationErr := client.AttackProtection.BotDetection.Read(
		context.TODO(),
	)
