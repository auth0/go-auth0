...
func TestAttackProtectionBruteForceProtectionGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/attack-protection/brute-force-protection")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"enabled": true, "shields": []interface{}{"block"}, "allowlist": []interface{}{"allowlist"}, "mode": "count_per_identifier_and_ip", "max_attempts": 1},
...
func TestAttackProtectionBruteForceProtectionUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/attack-protection/brute-force-protection")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
