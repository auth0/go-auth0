...
package attack_protection_suspicious_ip_throttling_test
...
func TestAttackProtectionSuspiciousIPThrottlingGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/attack-protection/suspicious-ip-throttling")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"enabled": true, "shields": []interface{}{"block"}, "allowlist": []interface{}{"allowlist"}, "stage": map[string]interface{}{"pre-login": map[string]interface{}{"max_attempts": 1, "rate": 1}, "pre-user-registration": map[string]interface{}{"max_attempts": 1, "rate": 1}}},
...
func TestAttackProtectionSuspiciousIPThrottlingUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/attack-protection/suspicious-ip-throttling")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
