...
import (
	...
	client "github.com/auth0/go-auth0/v3/management/organizations/members/effectiveroles/client"
	roles "github.com/auth0/go-auth0/v3/management/organizations/members/roles"
)

type Client struct {
	WithRawResponse *RawClient
	EffectiveRoles  *client.Client
	Roles           *roles.Client
...
func NewClient(options *core.RequestOptions) *Client {
	return &Client{
		EffectiveRoles:  client.NewClient(options),
