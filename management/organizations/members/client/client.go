...
func (c *Client) List(
...
) (*core.Page[*string, *management.OrganizationMember], error) {
	...
	readPageResponse := func(response *management.ListOrganizationMembersPaginatedResponseContent) *core.PageResponse[*string, *management.OrganizationMember] {
		var zeroValue *string
		next := response.Next
		results := response.Members
		return &core.PageResponse[*string, *management.OrganizationMember]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
