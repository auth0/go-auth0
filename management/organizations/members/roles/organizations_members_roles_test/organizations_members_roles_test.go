...
func TestOrganizationsMembersRolesListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/members/{user_id}/roles")).WithPathParam(
		"id",
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "roles": []interface{}{map[string]interface{}{"id": "id", "name": "name", "description": "description"}}},
...
func TestOrganizationsMembersRolesAssignWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations/{id}/members/{user_id}/roles")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"user_id",
...
func TestOrganizationsMembersRolesDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/organizations/{id}/members/{user_id}/roles")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"user_id",
