...
func (c *Client) List(
...
) (*core.Page[*int, *management.OrganizationInvitation, *management.ListOrganizationInvitationsOffsetPaginatedResponseContent], error) {
	...
	readPageResponse := func(response *management.ListOrganizationInvitationsOffsetPaginatedResponseContent) *core.PageResponse[*int, *management.OrganizationInvitation, *management.ListOrganizationInvitationsOffsetPaginatedResponseContent] {
		next += 1
		results := response.Invitations
		return &core.PageResponse[*int, *management.OrganizationInvitation, *management.ListOrganizationInvitationsOffsetPaginatedResponseContent]{
			Results:  results,
			Response: response,
			Next:     &next,
		}
