...
func TestOrganizationsInvitationsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/invitations")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "invitations": []interface{}{map[string]interface{}{"id": "id", "organization_id": "organization_id", "inviter": map[string]interface{}{"name": "name"}, "invitee": map[string]interface{}{"email": "email"}, "invitation_url": "invitation_url", "created_at": "2024-01-15T09:30:00Z", "expires_at": "2024-01-15T09:30:00Z", "client_id": "client_id", "connection_id": "connection_id", "app_metadata": map[string]interface{}{"key": "value"}, "user_metadata": map[string]interface{}{"key": "value"}, "roles": []interface{}{"roles"}, "ticket_id": "ticket_id"}}},
...
func TestOrganizationsInvitationsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations/{id}/invitations")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
                    ...
                    "properties": {
                        "inviter": {"type": "object"}, "invitee": {"type": "object"}, "client_id": {"type": "string"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "organization_id": "organization_id", "inviter": map[string]interface{}{"name": "name"}, "invitee": map[string]interface{}{"email": "email"}, "invitation_url": "invitation_url", "created_at": "2024-01-15T09:30:00Z", "expires_at": "2024-01-15T09:30:00Z", "client_id": "client_id", "connection_id": "connection_id", "app_metadata": map[string]interface{}{"key": "value"}, "user_metadata": map[string]interface{}{"key": "value"}, "roles": []interface{}{"roles"}, "ticket_id": "ticket_id"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestOrganizationsInvitationsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/invitations/{invitation_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"invitation_id",
		gowiremock.Matching("invitation_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "organization_id": "organization_id", "inviter": map[string]interface{}{"name": "name"}, "invitee": map[string]interface{}{"email": "email"}, "invitation_url": "invitation_url", "created_at": "2024-01-15T09:30:00Z", "expires_at": "2024-01-15T09:30:00Z", "client_id": "client_id", "connection_id": "connection_id", "app_metadata": map[string]interface{}{"key": "value"}, "user_metadata": map[string]interface{}{"key": "value"}, "roles": []interface{}{"roles"}, "ticket_id": "ticket_id"},
		).WithStatus(http.StatusOK),
...
func TestOrganizationsInvitationsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/organizations/{id}/invitations/{invitation_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"invitation_id",
