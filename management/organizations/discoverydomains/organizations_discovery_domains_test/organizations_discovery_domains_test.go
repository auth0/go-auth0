...
func TestOrganizationsDiscoveryDomainsListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/organizations/id/discovery-domains", map[string]string{"from": "from", "take": "1"}, 1)
}
...
func TestOrganizationsDiscoveryDomainsGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/organizations/id/discovery-domains/discovery_domain_id", nil, 1)
}
...
func TestOrganizationsDiscoveryDomainsDeleteWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "DELETE", "/organizations/id/discovery-domains/discovery_domain_id", nil, 1)
}
...
func TestOrganizationsDiscoveryDomainsUpdateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PATCH", "/organizations/id/discovery-domains/discovery_domain_id", nil, 1)
}
