...
func TestOrganizationsDiscoveryDomainsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/discovery-domains")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"next": "next", "domains": []interface{}{map[string]interface{}{"id": "id", "domain": "domain", "status": "pending", "verification_txt": "verification_txt", "verification_host": "verification_host"}}},
...
func TestOrganizationsDiscoveryDomainsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations/{id}/discovery-domains")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "domain": "domain", "status": "pending", "verification_txt": "verification_txt", "verification_host": "verification_host"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestOrganizationsDiscoveryDomainsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/discovery-domains/{discovery_domain_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"discovery_domain_id",
		gowiremock.Matching("discovery_domain_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "domain": "domain", "status": "pending", "verification_txt": "verification_txt", "verification_host": "verification_host"},
		).WithStatus(http.StatusOK),
...
func TestOrganizationsDiscoveryDomainsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/organizations/{id}/discovery-domains/{discovery_domain_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"discovery_domain_id",
...
func TestOrganizationsDiscoveryDomainsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/organizations/{id}/discovery-domains/{discovery_domain_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"discovery_domain_id",
