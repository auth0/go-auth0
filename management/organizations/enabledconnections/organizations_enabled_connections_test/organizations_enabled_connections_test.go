...
func TestOrganizationsEnabledConnectionsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/enabled_connections")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "enabled_connections": []interface{}{map[string]interface{}{"connection_id": "connection_id", "assign_membership_on_login": true, "show_as_button": true, "is_signup_enabled": true}}},
...
func TestOrganizationsEnabledConnectionsAddWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations/{id}/enabled_connections")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"connection_id": "connection_id", "assign_membership_on_login": true, "show_as_button": true, "is_signup_enabled": true, "connection": map[string]interface{}{"name": "name", "strategy": "strategy"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestOrganizationsEnabledConnectionsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}/enabled_connections/{connectionId}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"connectionId",
		gowiremock.Matching("connectionId"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"connection_id": "connection_id", "assign_membership_on_login": true, "show_as_button": true, "is_signup_enabled": true, "connection": map[string]interface{}{"name": "name", "strategy": "strategy"}},
		).WithStatus(http.StatusOK),
...
func TestOrganizationsEnabledConnectionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/organizations/{id}/enabled_connections/{connectionId}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"connectionId",
...
func TestOrganizationsEnabledConnectionsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/organizations/{id}/enabled_connections/{connectionId}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"connectionId",
