...
func TestOrganizationsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"next": "next", "organizations": []interface{}{map[string]interface{}{"id": "id", "name": "name", "display_name": "display_name", "token_quota": map[string]interface{}{"client_credentials": map[string]interface{}{}}}}},
...
func TestOrganizationsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/organizations")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "display_name": "display_name", "branding": map[string]interface{}{"logo_url": "logo_url", "colors": map[string]interface{}{"primary": "primary", "page_background": "page_background"}}, "metadata": map[string]interface{}{"key": "value"}, "token_quota": map[string]interface{}{"client_credentials": map[string]interface{}{"enforce": true, "per_day": 1, "per_hour": 1}}, "enabled_connections": []interface{}{map[string]interface{}{"connection_id": "connection_id", "assign_membership_on_login": true, "show_as_button": true, "is_signup_enabled": true}}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestOrganizationsGetByNameWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/name/{name}")).WithPathParam(
		"name",
		gowiremock.Matching("name"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "display_name": "display_name", "branding": map[string]interface{}{"logo_url": "logo_url", "colors": map[string]interface{}{"primary": "primary", "page_background": "page_background"}}, "metadata": map[string]interface{}{"key": "value"}, "token_quota": map[string]interface{}{"client_credentials": map[string]interface{}{"enforce": true, "per_day": 1, "per_hour": 1}}},
		).WithStatus(http.StatusOK),
...
func TestOrganizationsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/organizations/{id}")).WithPathParam(
		"id",
...
func TestOrganizationsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/organizations/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestOrganizationsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/organizations/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
