...
package supplemental_signals_test
...
func TestSupplementalSignalsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/supplemental-signals")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"akamai_enabled": true},
...
func TestSupplementalSignalsPatchWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/supplemental-signals")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["akamai_enabled"],
                    "properties": {
                        "akamai_enabled": {"type": "boolean"}
                    },
