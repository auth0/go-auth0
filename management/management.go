...
type Management struct {
	...
	// Event manages Auth0 Event resources for streaming events.
	Event *EventManager

	// EventStream manages Auth0 Event Stream resources.
	...
	// UserAttributeProfile manages Auth0 User Attribute Profiles.
	UserAttributeProfile *UserAttributeProfileManager
...
func New(domain string, options ...Option) (*Management, error) {
	...
	m.UserAttributeProfile = (*UserAttributeProfileManager)(&m.common)
