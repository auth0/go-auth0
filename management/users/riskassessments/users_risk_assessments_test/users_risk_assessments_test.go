...
func TestUsersRiskAssessmentsClearWithWireMock(
	...
	invocationErr := client.Users.RiskAssessments.Clear(
		...
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestUsersRiskAssessmentsClearWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUsersRiskAssessmentsClearWithWireMock", "POST", "/users/id/risk-assessments/clear", nil, 1)
}
