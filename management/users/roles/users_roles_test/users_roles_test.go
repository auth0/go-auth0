...
func TestUsersRolesListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/{id}/roles")).WithPathParam(
		"id",
...
func TestUsersRolesAssignWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/users/{id}/roles")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestUsersRolesDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/users/{id}/roles")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
