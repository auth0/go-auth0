...
func (c *Client) List(
...
) (*core.Page[*string, *management.ConnectedAccount], error) {
	...
	readPageResponse := func(response *management.ListUserConnectedAccountsResponseContent) *core.PageResponse[*string, *management.ConnectedAccount] {
		var zeroValue *string
		next := response.Next
		results := response.ConnectedAccounts
		return &core.PageResponse[*string, *management.ConnectedAccount]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
