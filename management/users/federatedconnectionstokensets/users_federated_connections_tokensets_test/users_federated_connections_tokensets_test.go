...
func TestUsersFederatedConnectionsTokensetsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/{id}/federated-connections-tokensets")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"id": "id", "connection": "connection", "scope": "scope", "expires_at": "2024-01-15T09:30:00Z", "issued_at": "2024-01-15T09:30:00Z", "last_used_at": "2024-01-15T09:30:00Z"}},
...
func TestUsersFederatedConnectionsTokensetsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/users/{id}/federated-connections-tokensets/{tokenset_id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithPathParam(
		"tokenset_id",
		gowiremock.Matching("tokenset_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
