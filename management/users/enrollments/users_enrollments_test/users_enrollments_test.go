...
package users_enrollments_test
...
func TestUsersEnrollmentsGetWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/{id}/enrollments")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"id": "id", "status": "pending", "type": "type", "name": "name", "identifier": "identifier", "phone_number": "phone_number", "auth_method": "authenticator", "enrolled_at": "2024-01-15T09:30:00Z", "last_auth": "2024-01-15T09:30:00Z"}},
	...
	_, invocationErr := client.Users.Enrollments.Get(
		context.TODO(),
		"id",
	)
