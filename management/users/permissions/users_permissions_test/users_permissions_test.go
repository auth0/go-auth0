...
func TestUsersPermissionsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/users/{id}/permissions")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "permissions": []interface{}{map[string]interface{}{"resource_server_identifier": "resource_server_identifier", "permission_name": "permission_name", "resource_server_name": "resource_server_name", "description": "description"}}},
...
func TestUsersPermissionsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/users/{id}/permissions")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestUsersPermissionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/users/{id}/permissions")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
