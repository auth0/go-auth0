...
func TestGettersListUserGrantsResponseContent(t *testing.T) {
	t.Run("GetUserGrantList", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &ListUserGrantsResponseContent{}
		var expected []*UserGrant
		obj.UserGrantList = expected

		// Act & Assert
		assert.Equal(t, expected, obj.GetUserGrantList(), "getter should return the property value")
	})

	t.Run("GetUserGrantList_NilValue", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &ListUserGrantsResponseContent{}
		obj.UserGrantList = nil

		// Act & Assert
		assert.Nil(t, obj.GetUserGrantList(), "getter should return nil when property is nil")
	})

	t.Run("GetUserGrantList_NilReceiver", func(t *testing.T) {
		t.Parallel()
		var obj *ListUserGrantsResponseContent
		// Should not panic - getters should handle nil receiver gracefully
		defer func() {
			if r := recover(); r != nil {
				t.Errorf("Getter panicked on nil receiver: %v", r)
		...
		_ = obj.GetUserGrantList() // Should return zero value
	})

	t.Run("GetListUserGrantsOffsetPaginatedResponseContent", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &ListUserGrantsResponseContent{}
		var expected *ListUserGrantsOffsetPaginatedResponseContent
		obj.ListUserGrantsOffsetPaginatedResponseContent = expected

		// Act & Assert
		assert.Equal(t, expected, obj.GetListUserGrantsOffsetPaginatedResponseContent(), "getter should return the property value")
	})

	t.Run("GetListUserGrantsOffsetPaginatedResponseContent_NilValue", func(t *testing.T) {
		t.Parallel()
		// Arrange
		obj := &ListUserGrantsResponseContent{}
		obj.ListUserGrantsOffsetPaginatedResponseContent = nil

		// Act & Assert
		assert.Nil(t, obj.GetListUserGrantsOffsetPaginatedResponseContent(), "getter should return nil when property is nil")
	})

	t.Run("GetListUserGrantsOffsetPaginatedResponseContent_NilReceiver", func(t *testing.T) {
		t.Parallel()
		var obj *ListUserGrantsResponseContent
		// Should not panic - getters should handle nil receiver gracefully
		defer func() {
		...
		_ = obj.GetListUserGrantsOffsetPaginatedResponseContent() // Should return zero value
	})
