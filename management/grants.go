...
type ListUserGrantsResponseContent struct {
	UserGrantList                                []*UserGrant
	ListUserGrantsOffsetPaginatedResponseContent *ListUserGrantsOffsetPaginatedResponseContent

	typ string
}

func (l *ListUserGrantsResponseContent) GetUserGrantList() []*UserGrant {
	if l == nil {
		return nil
	}
	return l.UserGrantList
}

func (l *ListUserGrantsResponseContent) GetListUserGrantsOffsetPaginatedResponseContent() *ListUserGrantsOffsetPaginatedResponseContent {
	if l == nil {
		return nil
	}
	return l.ListUserGrantsOffsetPaginatedResponseContent
}

func (l *ListUserGrantsResponseContent) UnmarshalJSON(data []byte) error {
	var valueUserGrantList []*UserGrant
	if err := json.Unmarshal(data, &valueUserGrantList); err == nil {
		l.typ = "UserGrantList"
		l.UserGrantList = valueUserGrantList
		return nil
	}
	valueListUserGrantsOffsetPaginatedResponseContent := new(ListUserGrantsOffsetPaginatedResponseContent)
	if err := json.Unmarshal(data, &valueListUserGrantsOffsetPaginatedResponseContent); err == nil {
		l.typ = "ListUserGrantsOffsetPaginatedResponseContent"
		l.ListUserGrantsOffsetPaginatedResponseContent = valueListUserGrantsOffsetPaginatedResponseContent
		return nil
	}
	return fmt.Errorf("%s cannot be deserialized as a %T", data, l)
}

func (l ListUserGrantsResponseContent) MarshalJSON() ([]byte, error) {
	if l.typ == "UserGrantList" || l.UserGrantList != nil {
		return json.Marshal(l.UserGrantList)
	}
	if l.typ == "ListUserGrantsOffsetPaginatedResponseContent" || l.ListUserGrantsOffsetPaginatedResponseContent != nil {
		return json.Marshal(l.ListUserGrantsOffsetPaginatedResponseContent)
	}
	return nil, fmt.Errorf("type %T does not include a non-empty union type", l)
}

type ListUserGrantsResponseContentVisitor interface {
	VisitUserGrantList([]*UserGrant) error
	VisitListUserGrantsOffsetPaginatedResponseContent(*ListUserGrantsOffsetPaginatedResponseContent) error
}

func (l *ListUserGrantsResponseContent) Accept(visitor ListUserGrantsResponseContentVisitor) error {
	if l.typ == "UserGrantList" || l.UserGrantList != nil {
		return visitor.VisitUserGrantList(l.UserGrantList)
	}
	if l.typ == "ListUserGrantsOffsetPaginatedResponseContent" || l.ListUserGrantsOffsetPaginatedResponseContent != nil {
		return visitor.VisitListUserGrantsOffsetPaginatedResponseContent(l.ListUserGrantsOffsetPaginatedResponseContent)
	}
