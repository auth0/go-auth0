...
package actions_executions_test
...
func TestActionsExecutionsGetWithWireMock(
	t *testing.T,
) {
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/actions/executions/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "trigger_id": "trigger_id", "status": "unspecified", "results": []interface{}{map[string]interface{}{"action_name": "action_name", "started_at": "2024-01-15T09:30:00Z", "ended_at": "2024-01-15T09:30:00Z"}}, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z"},
