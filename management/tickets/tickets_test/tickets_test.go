...
func TestTicketsVerifyEmailWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/tickets/email-verification")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
...
func TestTicketsChangePasswordWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/tickets/password-change")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": [],
                    "properties": {
