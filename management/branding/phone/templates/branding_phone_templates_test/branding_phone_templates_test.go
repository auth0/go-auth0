...
func TestBrandingPhoneTemplatesListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/branding/phone/templates")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"templates": []interface{}{map[string]interface{}{"id": "id", "channel": "channel", "customizable": true, "tenant": "tenant", "content": map[string]interface{}{}, "type": "otp_verify", "disabled": true}}},
...
func TestBrandingPhoneTemplatesCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/branding/phone/templates")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "channel": "channel", "customizable": true, "tenant": "tenant", "content": map[string]interface{}{"syntax": "syntax", "from": "from", "body": map[string]interface{}{"text": "text", "voice": "voice"}}, "type": "otp_verify", "disabled": true},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestBrandingPhoneTemplatesGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/branding/phone/templates/{id}")).WithPathParam(
		"id",
...
func TestBrandingPhoneTemplatesDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/branding/phone/templates/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestBrandingPhoneTemplatesUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/branding/phone/templates/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
...
func TestBrandingPhoneTemplatesResetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/branding/phone/templates/{id}/reset")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "x", "channel": "channel", "customizable": true, "tenant": "x", "content": map[string]interface{}{"syntax": "syntax", "from": "x", "body": map[string]interface{}{"text": "x", "voice": "x"}}, "type": "otp_verify", "disabled": true},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestBrandingPhoneTemplatesTestWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/branding/phone/templates/{id}/try")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
