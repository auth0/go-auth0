...
func TestBrandingTemplatesGetUniversalLoginWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/branding/templates/universal-login")).WillReturnResponse(
...
func TestBrandingTemplatesUpdateUniversalLoginWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/branding/templates/universal-login")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestBrandingTemplatesDeleteUniversalLoginWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/branding/templates/universal-login")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{},
		).WithStatus(http.StatusOK),
	)
