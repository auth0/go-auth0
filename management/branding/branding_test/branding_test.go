...
func TestBrandingGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/branding")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"colors": map[string]interface{}{"primary": "primary", "page_background": "page_background"}, "favicon_url": "favicon_url", "logo_url": "logo_url", "font": map[string]interface{}{"url": "url"}},
...
func TestBrandingUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/branding")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
