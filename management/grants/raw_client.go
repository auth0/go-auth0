...
func (r *RawClient) GetGrants(
	ctx context.Context,
	request *management.GetGrantsRequest,
	opts ...option.RequestOption,
) (*core.Response[*management.ListUserGrantsResponseContent], error) {
	...
	var response *management.ListUserGrantsResponseContent
	...
	return &core.Response[*management.ListUserGrantsResponseContent]{
...
func (r *RawClient) DeleteGrantsByUserID(
	ctx context.Context,
...
func (r *RawClient) DeleteGrantsByID(
	ctx context.Context,
