...
func TestRiskAssessmentsSettingsNewDeviceGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/risk-assessments/settings/new-device")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"remember_for": 1},
...
func TestRiskAssessmentsSettingsNewDeviceUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/risk-assessments/settings/new-device")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["remember_for"],
                    "properties": {
                        "remember_for": {"type": "integer"}
                    },
