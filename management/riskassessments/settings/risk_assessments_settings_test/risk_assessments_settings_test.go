...
func TestRiskAssessmentsSettingsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/risk-assessments/settings")).WillReturnResponse(
...
func TestRiskAssessmentsSettingsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/risk-assessments/settings")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
