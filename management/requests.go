...
var (
	...
	createClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 47)
)
...
type UpdateAculRequestContent struct {
	RenderingMode AculRenderingModeEnum `json:"rendering_mode" url:"-"`
...
var (
	...
	updateClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 47)
)
