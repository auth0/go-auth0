...
var (
	...
	createClientGrantRequestContentFieldAllowAllScopes            = big.NewInt(1 << 7)
)
...
var (
	...
	createClientRequestContentFieldExpressConfiguration                           = big.NewInt(1 << 48)
	createClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 49)
)
...
var (
	...
	updateTenantSettingsRequestContentFieldEnableAiGuide                                  = big.NewInt(1 << 32)
	updateTenantSettingsRequestContentFieldPhoneConsolidatedExperience                    = big.NewInt(1 << 33)
)
...
var (
	...
	updateClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 49)
)
