...
var (
	listCustomDomainsRequestParametersFieldTake          = big.NewInt(1 << 0)
	listCustomDomainsRequestParametersFieldFrom          = big.NewInt(1 << 1)
	listCustomDomainsRequestParametersFieldQ             = big.NewInt(1 << 2)
	listCustomDomainsRequestParametersFieldFields        = big.NewInt(1 << 3)
	listCustomDomainsRequestParametersFieldIncludeFields = big.NewInt(1 << 4)
	listCustomDomainsRequestParametersFieldSort          = big.NewInt(1 << 5)
)
...
// SetTake sets the Take field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListCustomDomainsRequestParameters) SetTake(take *int) {
	l.Take = take
	l.require(listCustomDomainsRequestParametersFieldTake)
}

// SetFrom sets the From field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (l *ListCustomDomainsRequestParameters) SetFrom(from *string) {
	l.From = from
	l.require(listCustomDomainsRequestParametersFieldFrom)
}
