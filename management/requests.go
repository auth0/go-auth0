...
var (
	...
	createClientRequestContentFieldTokenExchange                                  = big.NewInt(1 << 44)
	createClientRequestContentFieldParRequestExpiry                               = big.NewInt(1 << 45)
	createClientRequestContentFieldTokenQuota                                     = big.NewInt(1 << 46)
	createClientRequestContentFieldResourceServerIdentifier                       = big.NewInt(1 << 47)
	createClientRequestContentFieldThirdPartySecurityMode                         = big.NewInt(1 << 48)
	createClientRequestContentFieldRedirectionPolicy                              = big.NewInt(1 << 49)
	createClientRequestContentFieldExpressConfiguration                           = big.NewInt(1 << 50)
	createClientRequestContentFieldMyOrganizationConfiguration                    = big.NewInt(1 << 51)
	createClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 52)
)
...
var (
	...
	updateClientRequestContentFieldTokenExchange                                  = big.NewInt(1 << 46)
	updateClientRequestContentFieldParRequestExpiry                               = big.NewInt(1 << 47)
	updateClientRequestContentFieldExpressConfiguration                           = big.NewInt(1 << 48)
	updateClientRequestContentFieldMyOrganizationConfiguration                    = big.NewInt(1 << 49)
	updateClientRequestContentFieldAsyncApprovalNotificationChannels              = big.NewInt(1 << 50)
	updateClientRequestContentFieldThirdPartySecurityMode                         = big.NewInt(1 << 51)
	updateClientRequestContentFieldRedirectionPolicy                              = big.NewInt(1 << 52)
)
