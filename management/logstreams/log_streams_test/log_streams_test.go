...
func TestLogStreamsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/log-streams")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			[]interface{}{map[string]interface{}{"id": "id", "name": "name", "status": "active", "type": "http", "isPriority": true, "filters": []interface{}{map[string]interface{}{}}, "pii_config": map[string]interface{}{"log_fields": []interface{}{"first_name"}, "method": "mask", "algorithm": "xxhash"}, "sink": map[string]interface{}{"httpAuthorization": "httpAuthorization", "httpContentFormat": "JSONARRAY", "httpContentType": "httpContentType", "httpEndpoint": "httpEndpoint", "httpCustomHeaders": []interface{}{map[string]interface{}{}}}}},
...
func TestLogStreamsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/log-streams")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "status": "active", "type": "http", "isPriority": true, "filters": []interface{}{map[string]interface{}{"type": "category", "name": "auth.login.fail"}}, "pii_config": map[string]interface{}{"log_fields": []interface{}{"first_name"}, "method": "mask", "algorithm": "xxhash"}, "sink": map[string]interface{}{"httpAuthorization": "httpAuthorization", "httpContentFormat": "JSONARRAY", "httpContentType": "httpContentType", "httpEndpoint": "httpEndpoint", "httpCustomHeaders": []interface{}{map[string]interface{}{}}}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestLogStreamsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/log-streams/{id}")).WithPathParam(
		"id",
...
func TestLogStreamsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/log-streams/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestLogStreamsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/log-streams/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
