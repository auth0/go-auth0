...
func TestGroupsListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/groups", map[string]string{"connection_id": "connection_id", "name": "name", "external_id": "external_id", "fields": "fields", "include_fields": "true", "from": "from", "take": "1"}, 1)
}
...
func TestGroupsGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/groups/id", nil, 1)
}
