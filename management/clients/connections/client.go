...
func (c *Client) Get(
...
) (*core.Page[*string, *management.ConnectionForList], error) {
	...
	readPageResponse := func(response *management.ListClientConnectionsResponseContent) *core.PageResponse[*string, *management.ConnectionForList] {
		var zeroValue *string
		next := response.Next
		results := response.Connections
		return &core.PageResponse[*string, *management.ConnectionForList]{
			Next:    next,
			Results: results,
			Done:    next == zeroValue,
		}
