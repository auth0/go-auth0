...
// ResourceServerUpdate struct for ResourceServerUpdate
type ResourceServerUpdate struct {
...
func (o *ResourceServerUpdate) GetName() string {
...
func (o *ResourceServerUpdate) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ResourceServerUpdate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ResourceServerUpdate) SetName(v string) {
	o.Name = &v
}

// GetScopes returns the Scopes field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetScopes() []Scope {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetScopesOk() ([]Scope, bool) {
	if o == nil || IsNil(o.Scopes) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasScopes() bool {
	if o != nil && !IsNil(o.Scopes) {
		return true
	}
...
func (o *ResourceServerUpdate) SetScopes(v []Scope) {
	o.Scopes = v
}

// GetSigningAlg returns the SigningAlg field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetSigningAlg() ClientJwtConfigurationAlg {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetSigningAlgOk() (*ClientJwtConfigurationAlg, bool) {
	if o == nil || IsNil(o.SigningAlg) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasSigningAlg() bool {
	if o != nil && !IsNil(o.SigningAlg) {
		return true
	}
...
func (o *ResourceServerUpdate) SetSigningAlg(v ClientJwtConfigurationAlg) {
	o.SigningAlg = &v
}

// GetSigningSecret returns the SigningSecret field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetSigningSecret() string {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetSigningSecretOk() (*string, bool) {
	if o == nil || IsNil(o.SigningSecret) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasSigningSecret() bool {
	if o != nil && !IsNil(o.SigningSecret) {
		return true
	}
...
func (o *ResourceServerUpdate) SetSigningSecret(v string) {
	o.SigningSecret = &v
}
...
func (o *ResourceServerUpdate) GetSkipConsentForVerifiableFirstPartyClients() bool {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetSkipConsentForVerifiableFirstPartyClientsOk() (*bool, bool) {
	if o == nil || IsNil(o.SkipConsentForVerifiableFirstPartyClients) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasSkipConsentForVerifiableFirstPartyClients() bool {
	if o != nil && !IsNil(o.SkipConsentForVerifiableFirstPartyClients) {
		return true
	}
...
func (o *ResourceServerUpdate) SetSkipConsentForVerifiableFirstPartyClients(v bool) {
...
func (o *ResourceServerUpdate) GetAllowOfflineAccess() bool {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetAllowOfflineAccessOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowOfflineAccess) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasAllowOfflineAccess() bool {
	if o != nil && !IsNil(o.AllowOfflineAccess) {
		return true
	}
...
func (o *ResourceServerUpdate) SetAllowOfflineAccess(v bool) {
	o.AllowOfflineAccess = &v
}

// GetTokenLifetime returns the TokenLifetime field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetTokenLifetime() int32 {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetTokenLifetimeOk() (*int32, bool) {
	if o == nil || IsNil(o.TokenLifetime) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasTokenLifetime() bool {
	if o != nil && !IsNil(o.TokenLifetime) {
		return true
	}
...
func (o *ResourceServerUpdate) SetTokenLifetime(v int32) {
	o.TokenLifetime = &v
}

// GetTokenDialect returns the TokenDialect field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetTokenDialect() ResourceServerCreateTokenDialect {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetTokenDialectOk() (*ResourceServerCreateTokenDialect, bool) {
	if o == nil || IsNil(o.TokenDialect) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasTokenDialect() bool {
	if o != nil && !IsNil(o.TokenDialect) {
		return true
	}
...
func (o *ResourceServerUpdate) SetTokenDialect(v ResourceServerCreateTokenDialect) {
	o.TokenDialect = &v
}

// GetEnforcePolicies returns the EnforcePolicies field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetEnforcePolicies() bool {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetEnforcePoliciesOk() (*bool, bool) {
	if o == nil || IsNil(o.EnforcePolicies) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasEnforcePolicies() bool {
	if o != nil && !IsNil(o.EnforcePolicies) {
		return true
	}
...
func (o *ResourceServerUpdate) SetEnforcePolicies(v bool) {
	o.EnforcePolicies = &v
}

// GetClient returns the Client field value if set, zero value otherwise.
func (o *ResourceServerUpdate) GetClient() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetClientOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Client) {
...
func (o *ResourceServerUpdate) HasClient() bool {
	if o != nil && !IsNil(o.Client) {
		return true
	}
...
func (o *ResourceServerUpdate) SetClient(v map[string]interface{}) {
	o.Client = v
}
...
func (o *ResourceServerUpdate) GetTokenEncryption() ResourceServerTokenEncryption {
...
func (o *ResourceServerUpdate) GetTokenEncryptionOk() (*ResourceServerTokenEncryption, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasTokenEncryption() bool {
...
func (o *ResourceServerUpdate) SetTokenEncryption(v ResourceServerTokenEncryption) {
	o.TokenEncryption.Set(&v)
}

// SetTokenEncryptionNil sets the value for TokenEncryption to be an explicit nil
func (o *ResourceServerUpdate) SetTokenEncryptionNil() {
...
func (o *ResourceServerUpdate) UnsetTokenEncryption() {
...
func (o *ResourceServerUpdate) GetConsentPolicy() ResourceServerConsentPolicy {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ResourceServerUpdate) GetConsentPolicyOk() (*ResourceServerConsentPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasConsentPolicy() bool {
...
// and a boolean to check if the value has been set.
func (o *ResourceServerUpdate) GetAuthorizationDetailsOk() ([]interface{}, bool) {
	if o == nil || IsNil(o.AuthorizationDetails) {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasAuthorizationDetails() bool {
	if o != nil && !IsNil(o.AuthorizationDetails) {
		return true
	}
...
func (o *ResourceServerUpdate) SetAuthorizationDetails(v []interface{}) {
...
func (o *ResourceServerUpdate) GetProofOfPossession() ResourceServerProofOfPossession {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ResourceServerUpdate) GetProofOfPossessionOk() (*ResourceServerProofOfPossession, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ResourceServerUpdate) HasProofOfPossession() bool {
...
func (o *ResourceServerUpdate) SetProofOfPossession(v ResourceServerProofOfPossession) {
	o.ProofOfPossession.Set(&v)
}

// SetProofOfPossessionNil sets the value for ProofOfPossession to be an explicit nil
func (o *ResourceServerUpdate) SetProofOfPossessionNil() {
...
func (o *ResourceServerUpdate) UnsetProofOfPossession() {
	o.ProofOfPossession.Unset()
}

func (o ResourceServerUpdate) MarshalJSON() ([]byte, error) {
...
func (o ResourceServerUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableResourceServerUpdate struct {
	value *ResourceServerUpdate
	isSet bool
}

func (v NullableResourceServerUpdate) Get() *ResourceServerUpdate {
	return v.value
}

func (v *NullableResourceServerUpdate) Set(val *ResourceServerUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceServerUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceServerUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceServerUpdate(val *ResourceServerUpdate) *NullableResourceServerUpdate {
	return &NullableResourceServerUpdate{value: val, isSet: true}
}

func (v NullableResourceServerUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceServerUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
