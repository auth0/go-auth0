...
func (o *PostLogStreamsRequestOneOf4) GetFilters() []PostLogStreamsRequestOneOfFiltersInner {
...
// and a boolean to check if the value has been set.
func (o *PostLogStreamsRequestOneOf4) GetFiltersOk() ([]PostLogStreamsRequestOneOfFiltersInner, bool) {
	if o == nil || IsNil(o.Filters) {
		return nil, false
	}
...
func (o *PostLogStreamsRequestOneOf4) SetFilters(v []PostLogStreamsRequestOneOfFiltersInner) {
	o.Filters = v
}
