...
func (o *PostLogStreamsRequestOneOf4) GetIsPriority() bool {
...
// and a boolean to check if the value has been set.
func (o *PostLogStreamsRequestOneOf4) GetIsPriorityOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPriority) {
		return nil, false
	}
...
func (o *PostLogStreamsRequestOneOf4) HasIsPriority() bool {
	if o != nil && !IsNil(o.IsPriority) {
		return true
	}
...
func (o *PostLogStreamsRequestOneOf4) SetIsPriority(v bool) {
	o.IsPriority = &v
}
