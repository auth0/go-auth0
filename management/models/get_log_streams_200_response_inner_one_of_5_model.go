...
type GetLogStreams200ResponseInnerOneOf5 struct {
	...
	Type   *GetLogStreams200ResponseInnerOneOf5Type  `json:"type,omitempty"`
	...
	Sink                 *GetLogStreams200ResponseInnerOneOf5Sink         `json:"sink,omitempty"`
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
// SetType gets a reference to the given GetLogStreams200ResponseInnerOneOf5Type and assigns it to the Type field.
...
func (o *GetLogStreams200ResponseInnerOneOf5) GetIsPriority() bool {
...
// and a boolean to check if the value has been set.
func (o *GetLogStreams200ResponseInnerOneOf5) GetIsPriorityOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPriority) {
		return nil, false
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasIsPriority() bool {
	if o != nil && !IsNil(o.IsPriority) {
		return true
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) SetIsPriority(v bool) {
	o.IsPriority = &v
}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasFilters() bool {
	if o != nil && !IsNil(o.Filters) {
		return true
	}
...
func (o *GetLogStreams200ResponseInnerOneOf5) HasSink() bool {
	if o != nil && !IsNil(o.Sink) {
		return true
	}
...
// SetSink gets a reference to the given GetLogStreams200ResponseInnerOneOf5Sink and assigns it to the Sink field.
