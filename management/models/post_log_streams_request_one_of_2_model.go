...
func (o *PostLogStreamsRequestOneOf2) GetIsPriority() bool {
...
// and a boolean to check if the value has been set.
func (o *PostLogStreamsRequestOneOf2) GetIsPriorityOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPriority) {
		return nil, false
	}
...
func (o *PostLogStreamsRequestOneOf2) HasIsPriority() bool {
	if o != nil && !IsNil(o.IsPriority) {
		return true
	}
...
func (o *PostLogStreamsRequestOneOf2) SetIsPriority(v bool) {
	o.IsPriority = &v
}
