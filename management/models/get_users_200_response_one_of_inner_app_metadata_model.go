...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) GetMultifactorLastModified() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetUsers200ResponseOneOfInnerAppMetadata) GetMultifactorLastModifiedOk() (*interface{}, bool) {
...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) HasMultifactorLastModified() bool {
	if o != nil && !IsNil(o.MultifactorLastModified) {
		return true
	}
...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) SetMultifactorLastModified(v interface{}) {
...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) GetMultifactor() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GetUsers200ResponseOneOfInnerAppMetadata) GetMultifactorOk() (*interface{}, bool) {
...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) HasMultifactor() bool {
	if o != nil && !IsNil(o.Multifactor) {
		return true
	}
...
func (o *GetUsers200ResponseOneOfInnerAppMetadata) SetMultifactor(v interface{}) {
	o.Multifactor = v
}
