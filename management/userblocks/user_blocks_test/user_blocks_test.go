...
func TestUserBlocksListByIdentifierWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/user-blocks")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"blocked_for": []interface{}{map[string]interface{}{"identifier": "identifier", "ip": "ip", "connection": "connection"}}},
...
func TestUserBlocksDeleteByIdentifierWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/user-blocks")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestUserBlocksListWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/user-blocks/{id}")).WithPathParam(
		"id",
...
func TestUserBlocksDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/user-blocks/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
