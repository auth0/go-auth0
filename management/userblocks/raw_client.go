...
func (r *RawClient) ListByIdentifier(
	...
	endpointURL := baseURL + "/user-blocks"
	...
	var response *management.ListUserBlocksByIdentifierResponseContent
	...
	return &core.Response[*management.ListUserBlocksByIdentifierResponseContent]{
...
func (r *RawClient) List(
	...
	var response *management.ListUserBlocksResponseContent
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*management.ListUserBlocksResponseContent]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
