...
func TestTokenExchangeProfilesListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/token-exchange-profiles")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"next": "next", "token_exchange_profiles": []interface{}{map[string]interface{}{"id": "id", "name": "name", "subject_token_type": "subject_token_type", "action_id": "action_id", "type": "custom_authentication", "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z"}}},
...
func TestTokenExchangeProfilesCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/token-exchange-profiles")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": ["name", "subject_token_type", "action_id", "type"],
                    "properties": {
                        "name": {"type": "string"}, "subject_token_type": {"type": "string"}, "action_id": {"type": "string"}, "type": {"type": "string", "const": "custom_authentication"}
                    },
                    "additionalProperties": true
                }`, "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "subject_token_type": "subject_token_type", "action_id": "action_id", "type": "custom_authentication", "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestTokenExchangeProfilesGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/token-exchange-profiles/{id}")).WithPathParam(
		"id",
...
func TestTokenExchangeProfilesDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/token-exchange-profiles/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestTokenExchangeProfilesUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/token-exchange-profiles/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
