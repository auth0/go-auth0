...
func TestEmailTemplatesCreateWithWireMock(
	...
	VerifyRequestCount(t, "POST", "/email-templates", nil, 1)
}
...
func TestEmailTemplatesGetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "GET", "/email-templates/verify_email", nil, 1)
}
...
func TestEmailTemplatesSetWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PUT", "/email-templates/verify_email", nil, 1)
}
...
func TestEmailTemplatesUpdateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "PATCH", "/email-templates/verify_email", nil, 1)
}
