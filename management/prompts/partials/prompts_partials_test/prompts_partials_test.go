...
func TestPromptsPartialsGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/prompts/{prompt}/partials")).WithPathParam(
		"prompt",
...
func TestPromptsPartialsSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/prompts/{prompt}/partials")).WithPathParam(
		"prompt",
		gowiremock.Matching("login"),
