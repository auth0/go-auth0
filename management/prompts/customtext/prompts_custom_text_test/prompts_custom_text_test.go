...
func TestPromptsCustomTextGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/prompts/{prompt}/custom-text/{language}")).WithPathParam(
		"prompt",
		gowiremock.Matching("login"),
	).WithPathParam(
		"language",
		gowiremock.Matching("am"),
	).WillReturnResponse(
...
func TestPromptsCustomTextSetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/prompts/{prompt}/custom-text/{language}")).WithPathParam(
		"prompt",
		gowiremock.Matching("login"),
	).WithPathParam(
		"language",
