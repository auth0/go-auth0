...
func TestUserGrantsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/grants")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "grants": []interface{}{map[string]interface{}{"id": "id", "clientID": "clientID", "user_id": "user_id", "audience": "audience", "scope": []interface{}{"scope"}}}},
...
func TestUserGrantsDeleteByUserIDWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/grants")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestUserGrantsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/grants/{id}")).WithPathParam(
		"id",
