...
func (m *Manager) GetTokens(ctx context.Context, opts ...management.RequestOption) ([]*models.Token, error) {
...
func (m *Manager) PostTokens(ctx context.Context, token *models.Token, opts ...management.RequestOption) error {
