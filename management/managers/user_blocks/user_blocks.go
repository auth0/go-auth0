...
func (m *Manager) DeleteUserBlocks(ctx context.Context, opts ...management.RequestOption) error {
...
func (m *Manager) GetUserBlocks(ctx context.Context, opts ...management.RequestOption) (*models.UserBlock, error) {
