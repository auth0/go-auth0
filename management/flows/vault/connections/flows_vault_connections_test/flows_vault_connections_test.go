...
func TestFlowsVaultConnectionsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/flows/vault/connections")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "connections": []interface{}{map[string]interface{}{"id": "id", "app_id": "app_id", "name": "name", "account_name": "account_name", "ready": true, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "refreshed_at": "2024-01-15T09:30:00Z", "fingerprint": "fingerprint"}}},
...
func TestFlowsVaultConnectionsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/flows/vault/connections")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "app_id": "app_id", "environment": "environment", "name": "name", "account_name": "account_name", "ready": true, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "refreshed_at": "2024-01-15T09:30:00Z", "fingerprint": "fingerprint"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestFlowsVaultConnectionsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/flows/vault/connections/{id}")).WithPathParam(
		"id",
...
func TestFlowsVaultConnectionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/flows/vault/connections/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestFlowsVaultConnectionsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/flows/vault/connections/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
