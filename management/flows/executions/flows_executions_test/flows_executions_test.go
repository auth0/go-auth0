...
func TestFlowsExecutionsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/flows/{flow_id}/executions")).WithPathParam(
		"flow_id",
		gowiremock.Matching("flow_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"next": "next", "executions": []interface{}{map[string]interface{}{"id": "id", "trace_id": "trace_id", "journey_id": "journey_id", "status": "status", "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "started_at": "2024-01-15T09:30:00Z", "ended_at": "2024-01-15T09:30:00Z"}}},
...
func TestFlowsExecutionsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/flows/{flow_id}/executions/{execution_id}")).WithPathParam(
		"flow_id",
		gowiremock.Matching("flow_id"),
	).WithPathParam(
		"execution_id",
		gowiremock.Matching("execution_id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "trace_id": "trace_id", "journey_id": "journey_id", "status": "status", "debug": map[string]interface{}{"key": "value"}, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "started_at": "2024-01-15T09:30:00Z", "ended_at": "2024-01-15T09:30:00Z"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestFlowsExecutionsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/flows/{flow_id}/executions/{execution_id}")).WithPathParam(
		"flow_id",
		gowiremock.Matching("flow_id"),
	).WithPathParam(
		"execution_id",
