...
func TestFormsListWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/forms")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"start": 1.1, "limit": 1.1, "total": 1.1, "forms": []interface{}{map[string]interface{}{"id": "id", "name": "name", "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "embedded_at": "embedded_at", "submitted_at": "submitted_at"}}},
...
func TestFormsCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/forms")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
		...
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"id": "id", "name": "name", "messages": map[string]interface{}{"errors": map[string]interface{}{"key": "value"}, "custom": map[string]interface{}{"key": "value"}}, "languages": map[string]interface{}{"primary": "primary", "default": "default"}, "translations": map[string]interface{}{"key": map[string]interface{}{"key": "value"}}, "nodes": []interface{}{map[string]interface{}{"id": "id", "type": "FLOW", "coordinates": map[string]interface{}{"x": 1, "y": 1}, "alias": "alias", "config": map[string]interface{}{"flow_id": "flow_id"}}}, "start": map[string]interface{}{"hidden_fields": []interface{}{map[string]interface{}{"key": "key"}}, "next_node": "next_node", "coordinates": map[string]interface{}{"x": 1, "y": 1}}, "ending": map[string]interface{}{"redirection": map[string]interface{}{"delay": 1, "target": "target"}, "after_submit": map[string]interface{}{"flow_id": "flow_id"}, "coordinates": map[string]interface{}{"x": 1, "y": 1}, "resume_flow": true}, "style": map[string]interface{}{"css": "css"}, "created_at": "2024-01-15T09:30:00Z", "updated_at": "2024-01-15T09:30:00Z", "embedded_at": "embedded_at", "submitted_at": "submitted_at"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestFormsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/forms/{id}")).WithPathParam(
		"id",
...
func TestFormsDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/forms/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestFormsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/forms/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
