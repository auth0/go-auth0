...
func TestEmailsProviderGetWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/emails/provider")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"name": "name", "enabled": true, "default_from_address": "default_from_address", "credentials": map[string]interface{}{"api_user": "api_user", "region": "region", "smtp_host": "smtp_host", "smtp_port": 1, "smtp_user": "smtp_user"}, "settings": map[string]interface{}{"key": "value"}},
...
func TestEmailsProviderCreateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/emails/provider")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
...
func TestEmailsProviderDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/emails/provider")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestEmailsProviderUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/emails/provider")).WithBodyPattern(gowiremock.MatchesJsonSchema(`{
                    "$schema": "https://json-schema.org/draft/2020-12/schema",
                    "type": "object",
                    "required": [],
                    "properties": {
