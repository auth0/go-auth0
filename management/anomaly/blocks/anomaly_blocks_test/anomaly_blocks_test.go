...
func TestAnomalyBlocksCheckIPWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/anomaly/blocks/ips/{id}")).WithPathParam(
		"id",
...
func TestAnomalyBlocksUnblockIPWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/anomaly/blocks/ips/{id}")).WithPathParam(
		"id",
		gowiremock.Matching("id"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
