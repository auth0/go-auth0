...
func TestDeviceCredentialsListWithWireMock(
	...
	VerifyRequestCount(t, "GET", "/device-credentials", map[string]string{"page": "1", "per_page": "1", "include_totals": "true", "fields": "fields", "include_fields": "true", "user_id": "user_id", "client_id": "client_id", "type": "public_key"}, 1)
}
...
func TestDeviceCredentialsCreatePublicKeyWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "POST", "/device-credentials", nil, 1)
}
...
func TestDeviceCredentialsDeleteWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "DELETE", "/device-credentials/id", nil, 1)
}
